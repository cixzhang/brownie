...
var themes = {
  ...
  ocean: {
    ...
    '--color-background-body': 'light-dark(#f0f4f8, #0e1419)',
    '--color-background-card': 'light-dark(#ffffff, #1a1f26)',
    '--color-overlay-hover': 'light-dark(#e8f0f8, #1a2430)',
    '--color-background-muted': 'light-dark(#eaeef2, #181e25)',
  ...
  sunset: {
    ...
    '--color-background-body': 'light-dark(#f8f4f0, #1a1410)',
    '--color-background-card': 'light-dark(#ffffff, #261e1a)',
    '--color-overlay-hover': 'light-dark(#f8ede4, #2a1e16)',
    '--color-background-muted': 'light-dark(#f2ece6, #221a16)',
